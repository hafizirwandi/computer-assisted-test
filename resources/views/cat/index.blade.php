                 ...
                 <div class="card-body">
                     ...
                     <div class="d-flex align-items-center mb-2 pb-1">
                         <div class="avatar me-2">
                             <span class="avatar-initial rounded bg-label-primary"><i class="ti ti-notes ti-md"></i></span>
                         </div>
                         <h6 class="ms-1 mb-0">{{ $ujian->jlh_soal }} Soal</h6>
                     </div>
                 </div>
             </div>
         </div>
             ...
             <div class="card card-border-shadow-warning">
                 <div class="card-body">
                     ...
                     <div class="d-flex align-items-center mb-2 pb-1">
                         ...
                         <h6 class="ms-1 mb-0">{{ $ujian->waktu }} Menit</h6>
                     </div>
                 </div>
             </div>
         </div>
             ...
             <div class="card card-border-shadow-danger">
                 <div class="card-body">
                     ...
                     <div class="d-flex align-items-center mb-2 pb-1">
                         ...
                         <h6 class="ms-1 mb-0">{{ $ujian->soal->nama }}</h6>
                     </div>
             ...
             <div class="card card-border-shadow-info">
                 <div class="card-body">
                     ...
                     <div class="d-flex align-items-center mb-2 pb-1">
                         ...
                         <h6 class="ms-1 mb-0">{{ $ujian->kode_ujian }}</h6>
                     </div>
                 </div>
             </div>
         </div>
