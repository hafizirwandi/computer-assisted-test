         ...
         <div class="card-body">
             ...
             <form class="row g-3" method="post" action="{{ route('soal.butirsoal.store') }}">
                 ...
                 <div class="col-12 col-md-12">
                     ...
                     <textarea name="jawaban_a" class="form-control summernote" required></textarea>
                 </div>
                 <div class="col-12 col-md-12">
                     <label class="form-label">Jawaban B</label>
                     <textarea name="jawaban_b" class="form-control summernote" required></textarea>
                 </div>

                 <div class="col-12 col-md-12">
                     <label class="form-label">Jawaban C</label>
                     <textarea name="jawaban_c" class="form-control summernote" required></textarea>
                 </div>
                 <div class="col-12 col-md-12">
                     <label class="form-label">Jawaban D</label>
                     <textarea name="jawaban_d" class="form-control summernote" required></textarea>
                 </div>
                 <div class="col-12 col-md-12">
                     <label class="form-label">Jawaban E</label>
                     <textarea name="jawaban_e" class="form-control summernote" required></textarea>
                 </div>
