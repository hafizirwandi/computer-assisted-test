<div class="card mb-4">
    <div class="card-body">
        ...
        <form class="row g-3" method="post" action="{{ route('soal.butirsoal.store4') }}">
            @csrf
            ...
            <div class="col-12 col-md-6">
                ...
                <input type="text" name="poin_minimal" class="form-control" placeholder="Enter Text" required />
            </div>
            <div class="col-12 col-md-6">
                <label class="form-label">Poin Maksimal</label>
                <input type="text" name="poin_maksimal" class="form-control" placeholder="Enter Text" required />
            </div>

            <div class="col-12 col-md-6">
                <label class="form-label">Jawaban</label>
                <input type="text" name="jawaban" class="form-control" placeholder="Enter Text" required />
            </div>
