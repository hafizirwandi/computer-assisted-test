<div class="card mb-4">
    <div class="card-body">
        <form class="row g-3" method="post" action="{{ route('soal.butirsoal.store2') }}">
            @csrf
            ...
            <div class="col-12 col-md-12 d-none poin_benar_a poin_benar">
                <label class="form-label">Poin Benar A</label>
                <input type="text" name="poin_benar_a" class="form-control" placeholder="Enter Text" />
            </div>
            ...
            <div class="col-12 col-md-12 d-none poin_benar_b poin_benar">
                <label class="form-label">Poin Benar B</label>
                <input type="text" name="poin_benar_b" class="form-control" placeholder="Enter Text" />
            </div>
            ...
            <div class="col-12 col-md-12 d-none poin_benar_c poin_benar">
                <label class="form-label">Poin Benar C</label>
                <input type="text" name="poin_benar_c" class="form-control" placeholder="Enter Text" />
            </div>
            ...
            <div class="col-12 col-md-12 d-none poin_benar_d poin_benar">
                <label class="form-label">Poin Benar D</label>
                <input type="text" name="poin_benar_d" class="form-control" placeholder="Enter Text" />
            </div>
            ...
            <div class="col-12 col-md-12 d-none poin_benar_e poin_benar">
                <label class="form-label">Poin Benar E</label>
                <input type="text" name="poin_benar_e" class="form-control" placeholder="Enter Text" />
            </div>
