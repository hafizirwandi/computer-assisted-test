  ...
  <form class="row g-3" method="post" action="{{ route('sekolah.update', $data->id) }}">
      ...
      <div class="col-12 col-md-6">
          ...
          <input type="text" name="telp" class="form-control" placeholder="Enter Text" value="{{ $data->telp }}"
              required />
      </div>
      <div class="col-12 col-md-6">
      ...
      <div class="col-12 col-md-12">
          ...
          <textarea type="text" name="alamat" class="form-control" rows="5" placeholder="Enter Text">{{ $data->alamat }}</textarea>
      </div>
