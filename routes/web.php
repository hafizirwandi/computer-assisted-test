...
Route::middleware('auth:web')->group(function () {
    ...
    Route::get('/kirim-nilai/export', [KirimNilaiController::class, 'exportData'])->name('kirim-nilai.export');
    Route::get('/import-nilai', [ImportNilaiController::class, 'index'])->name('import-nilai');
    Route::post('/import-nilai/upload', [ImportNilaiController::class, 'upload'])->name('import-nilai.upload');
});
